...
@WebServlet("/PromotionInsertServlet")
public class PromotionInsertServlet extends HttpServlet {
   ...
   @Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = PromotionController.insertData(promo_code, description, discount_type, value, valid_from, valid_to, usage_limit, status);
