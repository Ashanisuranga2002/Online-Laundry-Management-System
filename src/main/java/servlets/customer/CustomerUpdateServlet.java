...
public class CustomerUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = CustomerController.updatedata(customer_id, name, phone, email, address, password);
		
		if(isTrue == true) {
			
			List <CustomerModel> customerdetails = CustomerController.getById(customer_id);
